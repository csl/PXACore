...
#define rFFRBR			(*((volatile DWORD *)(FFUART_BASE+0x00)))
#define rFFTHR 			(*((volatile DWORD *)(FFUART_BASE+0x00)))
#define rFFIER 			(*((volatile DWORD *)(FFUART_BASE+0x04)))
#define rFFIIR 			(*((volatile DWORD *)(FFUART_BASE+0x08)))
#define rFFFCR 			(*((volatile DWORD *)(FFUART_BASE+0x08)))
#define rFFLCR 			(*((volatile DWORD *)(FFUART_BASE+0x0C)))
#define rFFMCR 			(*((volatile DWORD *)(FFUART_BASE+0x10)))
#define rFFLSR 			(*((volatile DWORD *)(FFUART_BASE+0x14)))
#define rFFMSR			(*((volatile DWORD *)(FFUART_BASE+0x18)))
#define rFFSPR 			(*((volatile DWORD *)(FFUART_BASE+0x1C)))
#define rFFISR 			(*((volatile DWORD *)(FFUART_BASE+0x20)))
#define rFFDLL 			(*((volatile DWORD *)(FFUART_BASE+0x00)))
#define rFFDLH 			(*((volatile DWORD *)(FFUART_BASE+0x04)))
