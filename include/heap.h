...
//struct __FREE_BLOCK_HEADER{
	...
	__FREE_BLOCK_HEADER*  lpPrev;                  //Pointing to previous free block.
...
//struct __HEAP_OBJECT{
	...
	__HEAP_OBJECT*              lpPrev;            //Pointing to previous heap object.
	__HEAP_OBJECT*              lpNext;            //Pointing to next heap object.
END_DEFINE_OBJECT()
//};
...
//we also implement these routines in Hello Taiwan.
//
