...
// In Hello Taiwan,the kernal memory space is from 0x00000000 to 0x013FFFFF of the
// PHYSICAL memory,it's size is 20M,so,to run Hello Taiwan,the target machine's
...
// When the Hello Taiwan is loaded into memory,it begins to execute,first,it form
...
// memory space,in that time,Hello Taiwan will move itself from low 1M space to up space,
// and the low 1M space is reserved to use in future.
// In currently,Hello Taiwan kernal's size would not exceed 1M,so we reserve 1M space to
// be used by Hello Taiwan kernal,that space is from 0x00100000 to 0x00200000 of physical
// memory.
...
// The space between Hello Taiwan kernal to stack space is used to as kernal memory,so,the
...
//                                              for future use.
//    0x00100000  ---------  0x001FFFFF  1M     Hello Taiwan's kernal,including Mini-Kernal and 
//                                              Master.
